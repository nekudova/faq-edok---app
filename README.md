...
Odstraněna závislost `passlib[bcrypt]`, protože Render stále spouštěl Python 3.14 a bcrypt padal při startu.
Hashování dočasného admin hesla je nyní přes standardní knihovnu Pythonu: PBKDF2-SHA256.
